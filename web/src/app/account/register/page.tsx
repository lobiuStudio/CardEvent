  ...
  return (
    <main className="flex min-h-dvh flex-1 bg-zinc-50 px-4 py-8">
      <section className="mx-auto flex w-full max-w-md flex-col justify-center">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold tracking-normal text-zinc-950">Create account</h1>
          <p className="mt-2 text-base text-zinc-600">Register for CardEvent grading activities.</p>
        </div>
