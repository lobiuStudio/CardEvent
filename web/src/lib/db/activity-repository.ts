...
export async function createActivity(input: CreateActivityInput) {
  return prisma.activity.create({
    data: {
      ...
      coverImageStorageProvider: input.coverImage?.provider,
      coverImageStorageFileId: input.coverImage?.fileId,
      coverImagePublicUrl: input.coverImage?.publicUrl,
      coverImageOriginalName: input.coverImage?.originalName,
      coverImageMimeType: input.coverImage?.mimeType,
      coverImageFileSize: input.coverImage?.fileSize,
